...
public class AddressService {
     ...
     */
    public static String coordToAddr(String longitude, String latitude,String apiKey){
        String url = "https://dapi.kakao.com/v2/local/geo/coord2address.json?x="+longitude+"&y="+latitude;
        String addr = "";
        try{
            addr = getRegionAddress(getJSONData(url,apiKey));
            //LOGGER.info(addr);
        }catch(Exception e){
     ...
     */
    private static String getJSONData(String apiUrl,String apiKey) throws Exception {
    ...
    private static String getRegionAddress(String jsonString) {
        ...
        long size = Long.valueOf(String.valueOf(meta.get("total_count")));
        if(size>0){
